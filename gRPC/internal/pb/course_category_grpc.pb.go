...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *Black, opts ...grpc.CallOption) (*CategoryList, error)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *Black, opts ...grpc.CallOption) (*CategoryList, error) {
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *Black) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *Black) (*CategoryList, error) {
...
func _CategoryService_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategories(ctx, req.(*Black))
	}
	return interceptor(ctx, in, info, handler)
}
