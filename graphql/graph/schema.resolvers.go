...
func (r *courseResolver) Category(ctx context.Context, obj *model.Course) (*model.Category, error) {
	category, err := r.CategoryDB.GetCategoryByCourseId(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCategories(ctx context.Context, input model.NewCategory) (*model.Category, error) {
...
// CreateCourses is the resolver for the createCourses field.
func (r *mutationResolver) CreateCourses(ctx context.Context, input model.NewCourse) (*model.Course, error) {
